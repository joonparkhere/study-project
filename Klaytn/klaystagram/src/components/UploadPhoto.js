...
import * as recordActions from 'redux/actions/custom'
...
class UploadPhoto extends Component {
  ...
  handleSubmit = (e) => {
    ...
    this.props.recordMemory(file, fileName, location, caption)
    ui.hideModal()
  }
...
const mapDispatchToProps = (dispatch) => ({
  recordMemory: (file, fileName, location, caption) =>
    dispatch(recordActions.recordMemory(file, fileName, location, caption)),
})
